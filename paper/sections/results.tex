...
Table~\ref{tab:solver-validation} summarizes the numerical evidence supporting the finite-horizon temporal-output procedure. The categories distinguish the broader numerical and independent-comparator studies from the current checks applied to the datasets used in the present experiments.
...
\begin{tabular}{p{0.23\linewidth}p{0.55\linewidth}p{0.13\linewidth}}
    ...
    Internal numerical checks & $86$ cases; $48$ analytical, numerical, and stability criteria & met criteria \\
    GeoClaw/Clawpack comparisons & $3$ primary, $2$ verification, and $7$ refinement cases & met criteria \\
    Exploratory GeoClaw/Clawpack & $12$ representative finite-horizon cases & $11 / 12$ above limits \\
    Integrated procedure checks & $90$ buffered common-time cases; $3$ repeatability checks & repeatable \\
    H2 sensitivity checks & $363$ pairs; $726$ executions; $42$ fixed criteria & met criteria \\
...
The independent-comparator evidence is deliberately limited and retains the scope of the numerical studies. The current checks re-audited the three datasets across all train, validation, and test splits and reran nine representative solver cases; the broader numerical and comparator matrices remain separate evidence rather than being treated as part of that rerun. All analytical, verification, and refinement comparisons satisfied their predefined criteria, whereas $11$ of $12$ exploratory descriptive comparisons exceeded their provisional limits. Table~\ref{tab:geoclaw-ablation} summarizes a controlled follow-up on three prespecified representative finite-horizon shallow-water cases; these results are retained as scope-limited comparator evidence rather than presented as a dataset-wide validation.
...
\begin{tabular}{lcc}
    \toprule
    Study configuration & Hydrostatic & MUSCL-HR \\
    \midrule
